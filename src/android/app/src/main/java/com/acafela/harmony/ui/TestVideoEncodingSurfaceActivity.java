 ...
 */
public class TestVideoEncodingSurfaceActivity extends Activity
    ...
    static class CameraHandler extends Handler {
        ...
        private WeakReference<TestVideoEncodingSurfaceActivity> mWeakActivity;

        public CameraHandler(TestVideoEncodingSurfaceActivity activity) {
            mWeakActivity = new WeakReference<TestVideoEncodingSurfaceActivity>(activity);
        }
        ...
        public void handleMessage(Message inputMessage) {
            ...
            TestVideoEncodingSurfaceActivity activity = mWeakActivity.get();
            if (activity == null) {
...
class CameraSurfaceRenderer implements GLSurfaceView.Renderer {
    ...
    private TestVideoEncodingSurfaceActivity.CameraHandler mCameraHandler;
     ...
     */
    public CameraSurfaceRenderer(TestVideoEncodingSurfaceActivity.CameraHandler cameraHandler,
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        mCameraHandler.sendMessage(mCameraHandler.obtainMessage(
                TestVideoEncodingSurfaceActivity.CameraHandler.MSG_SET_SURFACE_TEXTURE, mSurfaceTexture));
    }
        ...
        if (mRecordingEnabled) {
            switch (mRecordingStatus) {
                case RECORDING_OFF:
                    ...
                    // start recording
                    mVideoEncoder.startRecording(new TextureMovieEncoder.EncoderConfig(EGL14.eglGetCurrentContext()));
